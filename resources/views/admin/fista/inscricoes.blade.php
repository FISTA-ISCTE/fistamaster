                                ...
                                <table class="table table-bordered">
                                    <thead class="bg-dark text-white">
                                        <tr>
                                            ...
                                            <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Download
                                            </th>
                                        </tr>
                                    </thead>
                                        ...
                                        @foreach ($empresas as $empresa)
                                            <tr>
                                                ...
                                                <td class="text-left py-3 px-4">
                                                    <img src="https://fista.iscte-iul.pt/storage/{{ $empresa->avatar }}"
                                                        alt="Logo" style="width: 100px; height: auto;">
                                                </td>
                                                <td class="text-left py-3 px-4">
                                                    <a href="https://fista.iscte-iul.pt/storage/{{ $empresa->avatar }}"
                                                        download="Logo-{{ $empresa->nome_empresa }}">Download</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
