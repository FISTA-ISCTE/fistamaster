                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="text-gray-700">
                                        @foreach ($ctfInscritos as $ctfInscrito)
                                            <tr>
                                                <td class="text-left py-3 px-4">{{ $ctfInscrito->nome_grupo }}</td>
                                                @for($i=1;$i < 4; $i++)
                                                    <td class="text-left py-3 px-4">{{ $ctfInscrito->{'nome' . $i} }}</td>
                                                    <td class="text-left py-3 px-4">{{ $ctfInscrito->{'email' . $i} }}</td>
                                                @endfor
                                            </tr>
                                        @endforeach
                                    </tbody>
