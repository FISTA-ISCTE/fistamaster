                                ...
                                <div class="blog-post-wrap" style="padding:0px 0px 100px;">
                                    ...
                                    <div class="row" style="display:flex; align-items:center;cursor:default;">
                                        <div class="round-container">
                                            ...
                                            <a style="background:#ffffff; display: flex; justify-content: center; align-items: center; height: 100%;cursor:default;"
                                                href="#0"><img style="width:100px;"
                                                    src="https://fista.iscte-iul.pt/img/fista/original_fista.png" alt=""></a>
                                        </div>
                                        <h1 style="font-size:30px; padding-left:15px;">
                                           FISTA24 - De Alunos para alunos</h1>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span class="col align-self-end tag team-social text-right"
                                                        ...
                                                        <a href="{{ $feed->empresa->linkedin }}"
                                                            alt=""class="icon-link"><i class="fab fa-linkedin"
                                                                style="font-size:18px"></i></a>
                                                        <a href="{{ $feed->empresa->website }}" class="icon-link"><i
                                                                class="fab fas fa-globe" style="font-size:18px"></i></a>
                                                    </span>
                                                </div>
                                            </div>
                                            <h3 class="title"><a href="#0"
                                                    style="cursor:default">{{ $feed->titulo }}</a></h3>
                                ...
                                @foreach ($feeds as $feed)
                                    <div class="blog-post-wrap" style="padding:0px 0px 100px;">
                                        ...
                                        <div class="row" style="display:flex; align-items:center;cursor:default;">
                                            ...
                                            <h1 style="font-size:30px; padding-left:15px;">
                                                {{ $feed->empresa->nome_empresa }}</h1>

                                        </div>
                                        <div class="single-blog-post single-blog" style="margin-top:30px">
                                            <div class="blog-image">
                                                <a href="#0"><img src="../storage/{{ $feed->avatar1 }}"
                                                        alt=""></a>
                                                <div class="top-meta">
                                                    <span
                                                        class="date"><span>{{ date('d', $feed->created_at->timestamp) }}</span>{{ date('M', $feed->created_at->timestamp) }}</span>
                                                ...
                                                <div class="blog-meta">
                                                    <div class="row">
                                                        ...
                                                        <span class="col align-self-end tag team-social text-right"
                                                            style="margin-right:0px;">
                                                            <a href="{{ $feed->empresa->linkedin }}"
                                                                alt=""class="icon-link"><i
                                                                    class="fab fa-linkedin"
                                                                    style="font-size:18px"></i></a>
                                                            <a href="{{ $feed->empresa->website }}"
                                                                class="icon-link"><i class="fab fas fa-globe"
                                                                    style="font-size:18px"></i></a>
                                                        </span>
                                                    </div>
                                                </div>
