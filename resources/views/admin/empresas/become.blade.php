...
@section('content')
        <!-- Page Banner Start -->
        <div class="section page-banner-section" style="background: url({{asset('img/fotobecomeapartner.jpg')}}); background-size: cover;min-height:35rem;">
            <div class="container">
                <div class="page-banner" style="margin-top:0.5%;margin-bottom:5%;">
                    ...
                    <div class="row text-center">
                        <h4 class="title" style="color:black; text-shadow: 2px 2px 2px rgba(0, 0, 0, 0.5);font-size: 1.5rem !important">28 e 29 de Fevereiro de 2024</h4>
                    </div>
                </div>
            </div>
        </div>
