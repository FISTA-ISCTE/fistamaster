    ...
    <div class="container">
        <div class="row justify-content-start">
            <div class="col-lg-6 col-md-12 text-left">
                ...
                <h1 style="font-size:60px;line-height: 1.2;font-weight: bold;padding-top:8.5rem;">Ciclo de <br>conferências
                </h1>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row" style="margin:0">
                    <div class="col-lg-6 col-md-12 align-self-end">
                        ...
                        <p style="margin-top:20px;font-size: 23px;text-align:justify;padding: 0 2% 0 2%">O Ciclo de
                            conferências de Arquitetura do FISTA conta com uma série de
                            convidados, nacionais e internacionais.
                            Este é um momento de aproximação dos
                            alunos com quem põe a Arquitetura em prática,
                            mostrando diferentes visões e possibilidades. </p>
                    </div>
                    <div class="col-lg-6 col-md-12 align-self-end">
                        <img src="/arquitetura/conferencias/2024/capa.png"
    ...
    <section style="width:100%;padding:3rem 0;">
        <div class="container">
            ...
            @foreach ($pastyears as $pastyear)
                <h1 style="font-size:30px;line-height: 1;font-weight: lighter;margin-left:40px; padding: 2rem 0;">Edição
                    {{ $pastyear }}</h1>
                                ...
                                @if ($lastconference->ano == $pastyear)
                                    <li>
                                        <img class="carousel-image"
                                            style="width:180px;height:250px;"src="{{ asset($lastconference->avatar) }}"
                                            alt="Card Title">
