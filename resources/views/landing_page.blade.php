...
@section('content')
    ...
    <!-- Hero Start -->
    <div class="section techwix-hero-section-04 d-flex align-items-center"
        ...
        <div class="container banner1">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <!-- Hero Content Start -->
                    <div class="hero-content text-center" style="margin-top:1rem;">
                        <h5 class="sub-title" data-aos-delay="600" data-aos="fade-up">BEM VINDO AO MUNDO DAS TECNOLOGIAS E DA
                            ARQUITETURA</h5>
                        <h2 class="title" data-aos="fade-up" data-aos-delay="800"><img
                                style="width:500px"src="img/fista/branco 24.png" alt="Logo"></h2>
                        <p data-aos="fade-up" style="font-size:1.3rem;" data-aos-delay="900"><i class="flaticon-pin"></i>
                            Iscte - Instituto Universitário de Lisboa</p>
                        <p data-aos="fade-up" style="font-size:1.6rem; font-weight:bold; margin-top:20px;"
            ...
            <div class="features-wrap">
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-4 col-lg-6">
                        ...
                        <div class="features-item" style="background-image: url(assets/images/bg/feat-bg.jpg);">
                            <div class="features-icon">
                                <img src="assets/images/fista-stats/group.png" style="width:80px;height:80px; "alt="">
                            </div>
                            <div class="features-content">
                                <div class="row pb-1">
                                    <h3 class="title"
                                        style="font-size:3rem;font-weight:bold;color:#1EC4BD;text-align:left">+3100</h3>
                                </div>
                                <div class="row pt-1">
                                    <h5 class="title">Participantes</h3>
                                </div>
                            </div>
                        </div>
                        <!-- Features Item End -->
                    ...
                    <div class="col-md-4 col-xl-4 col-lg-6">
                        ...
                        <div class="features-item" style="background-image: url(assets/images/bg/feat-bg.jpg);">
                            <div class="features-icon">
                                <img src="assets/images/fista-stats/companies.svg" style="width:80px;height:80px; "alt="">
                            </div>
                            <div class="features-content">
                                <div class="row pb-1">
                                    <h3 class="title"
                                        style="font-size:3rem;font-weight:bold;color:#1EC4BD;text-align:left">+90</h3>
                                </div>
                                <div class="row pt-1">
                                    <h5 class="title">Empresas</h3>
                                </div>
                            </div>
                        </div>
                        <!-- Features Item End -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="about-img-wrap">
                            ...
                            <div class="about-img">
                                <img src="img/fotos/300x452.jpg" alt="">
                            </div>
                            <div class="about-img about-img-2">
                                <img src="img/fotos/300x462.jpg" alt="">
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="about-list-item-03">
                                            ...
                                            <p>O FISTA é um evento de alunos para alunos, que tem como objetivo aproximar os
                                                estudantes das Tecnologias e de Arquitetura ao mundo profissional.
                                            </p>
                                        </div>
                                    </div>
    ...
    <div class="section techwix-service-section-04 ">
        <div class="container">
            <h1 style="font-size:2.5rem;font-weight:bold;color:#1EC4BD;text-align:center;margin-top:2rem;">Empresas Diamond
            </h1>
            ...
            <div class="service-wrap">
                ...
                <div class="service-bottom ">
                    <div class="row justify-content-center" style="margin:0;margin-bottom:3%;">
                        @foreach ($empresasdiamount as $empresadiamount)
                            <div class='col-md-4 text-center' style="margin-left: auto;margin-right: auto; padding:10px;">
                                <a <?php if (!empty($empresadiamount->website)) {
                                    ...
                                    <div class="card" style="margin-bottom:15px;width:100%;border: 0px;">
                ...
                <div class="service-bottom ">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="service-item-03">
                                <div class="service-img">
                                    <a href="/brevemente"><img src="img/conjunto/fotoitspeedtalks.jpg"
                                            alt=""></a>
                                </div>
                                <div class="service-text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="service-item-03">
                                <div class="service-img">
                                    <a href="/concurso-de-ideias"><img src="img/conjunto/fotoconcursos.jpg"
                                            alt=""></a>
                                </div>
                                <div class="service-text">
                                    <h3 class="title"><a href="/concurso-de-ideias">Concursos</a></h3>
                                </div>
                            </div>
                            <!-- Service Item End -->
                        </div>
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="service-item-03">
                                <div class="service-img">
                                    <a href="/brevemente"><img src="assets/images/brand/32930549451_a09d298edd_c.jpg"
                                            alt=""></a>
                                </div>
                                <div class="service-text">
            ...
            <div class="video-wrap" style="background-image: url(img/play.jpg);">
                ...
                <div class="video-content text-center">
                    ...
                    <div class="play-btn-02">
                        <a class="popup-video" href="https://www.youtube.com/watch?time_continue=3&v=i-DRgyXc15U"><i
    ...
    <div class="section techwix-choose-us-section-02 section-padding-02"
        ...
        <div class="container">
            ...
            <div class="choose-us-wrap">
                ...
                <div class="row">
                    <h3 style="font-size:1.5rem;font-weight:bold;color:#1EC4BD;text-align:left;margin-bottom:1%">Para
                        alunos:</h3>
                </div>
                <div class="row">
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                <span class="title">Quem pode participar no FISTA?</span>
                                            </button>
                                        </div>
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                O FISTA é voltado principalmente para alunos do Iscte, mas também é aberto a
                                                visitantes externos que desejam conhecer as empresas participantes.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <span class="title">Como me posso inscrever para o FISTA24?</span>
                                            </button>
                                        </div>
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                As inscrições são realizadas no nosso site, na página Minha Conta ->
                                                Registar onde terás de registar as informações relativas ao teu perfil.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <span class="title">O FISTA é um evento completamente gratuito?</span>
                                            </button>
                                        </div>
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                Sim, poderás participar em todos os momentos associados ao FISTA sem
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="collapseThree">
                                                <span class="title">Como me inscrevo nas atividades associadas ao
                                                    FISTA?</span>
                                            </button>
                                        </div>
                                        <div id="collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                Poderás inscrever-te nos workshops, speed interviews e os concursos através
                                                do nosso website, após efetuares o login.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="heading5">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="collapseThree">
                                                <span class="title">Como posso fazer parte da equipa do FISTA24? </span>
                                            </button>
                                        </div>
                                        <div id="collapse5" class="accordion-collapse collapse"
                                            aria-labelledby="heading5" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                Poderás fazer parte do staff da equipa do FISTA24 se fores aluno da ISTA ou
                                                da escola de Sintra. Está atento às nossas redes sociais onde iremos
                                                partilhar o forms de inscrição.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row justify-content-center" style="margin:0;">
                        ...
                        <div class='col-md-4 text-center' style="margin-left: auto;margin-right: auto; padding:10px;">
                            <a href='#' style="width:100%;padding-left:7%;padding-right:7%">
                                <div class="card" style="margin-bottom:15px;width:100%;border:0px;">
                                    <img src="{{ asset('img/media/rfm.png') }}" alt="RFM" class="imgmedia"
                        ...
                        <div class='col-md-4 text-center' style="margin-left: auto;margin-right: auto; padding:10px;">
                            <a href='#' style="width:100%;padding-left:7%;padding-right:7%">
                                <div class="card" style="margin-bottom:15px;width:100%;border:0px;">
                                    <img src="{{ asset('img/media/mop.png') }}" alt="RFM" class="imgmedia"
                                        style="object-fit:contain">
                                </div>
                            </a>
                        </div>
    ...
    <div class="section techwix-brand-section techwix-brand-section-03">
        <div class="container">
            <!-- Brand Wrapper Start -->
            <div class="brand-wrapper text-center">
                <h1 style="font-size:2.5rem;font-weight:bold;color:#1EC4BD;text-align:center;margin-bottom:3%">Banda
                </h1>
                <!-- Brand Active Start -->
                <div class="brand-active">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <!-- Single Brand Start -->
                            <div class="swiper-slide single-brand">
                                <img src="assets/images/parceiros/Simbolo Tree Fish.jpg" alt="Brand" style="height:4rem">
                            </div>
                ...
                <div class="brand-active">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <!-- Single Brand Start -->
                            <div class="swiper-slide single-brand">
                                <img src="assets/images/parceiros/ista.svg" alt="Brand" style="height:4rem">
                            </div>
                            <!-- Single Brand End -->
                            <!-- Single Brand Start -->
                            <div class="swiper-slide single-brand">
                                <img src="assets/images/parceiros/net.svg" alt="Brand" style="height:4rem">
                            </div>
                            <!-- Single Brand End -->
                            <!-- Single Brand Start -->
                            <div class="swiper-slide single-brand">
                                <img src="assets/images/parceiros/nau.svg" alt="Brand" style="height:4rem">
                            </div>
                            <!-- Single Brand End -->
                            <!-- Single Brand Start -->
                            <div class="swiper-slide single-brand">
