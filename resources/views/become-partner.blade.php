...
<body>
    ...
    <div class="main-wrapper">
                                ...
                                <div class="cart-items">
                                    ...
                                    <div class="single-cart-item">
                                        <div class="item-image">
                                            <img src="{{asset('/images/shop-cart-1.jpg')}}" alt="cart">
                                        </div>
                                    ...
                                    <div class="single-cart-item">
                                        <div class="item-image">
                                            <img src="{{asset('/images/shop-cart-2.jpg')}}" alt="cart">
                                        </div>
                                        <div class="item-content">
                                    ...
                                    <div class="single-cart-item">
                                        <div class="item-image">
                                            <img src="{{asset('/images/shop-cart-3.jpg')}}" alt="cart">
                                        </div>
                                        <div class="item-content">
        ...
        <div class="section footer-section footer-section-03" style="background-image: url('{{asset('images/bg/footer-bg.jpg')}}');">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="footer-widget-about">
                                <a class="footer-logo" href="index.html"><img src="{{asset('/images/logo-white.png')}}" alt="Logo"></a>
