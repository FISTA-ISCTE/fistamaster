        ...
        <div style="padding-top:0px;background-color:white">
            <div class="row" style="margin:0">
                <div class="col-lg-6 col-md-12 " style="display: flex; flex-direction: column; justify-content: space-between;" >
                    ...
                    <p style="margin-top:20px;font-size: 23px;text-align:justify;padding: 0 2% 0 2%; margin-bottom: 0; ">Saber de fazer é a exposição anual do FISTA, que conta com uma seleção de trabalhos realizados integralmente pelos
