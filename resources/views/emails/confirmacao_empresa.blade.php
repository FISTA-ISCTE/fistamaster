...
<body>
    <div class="email-card">
        ...
        <p>Para concluir o processo de registo, por favor, <a href="htpps://fista.iscte-iul.pt/registar-user?empresa={{$id}}">htpps://fista.iscte-iul.pt/registar-user?empresa={{$id}}</a></p>
