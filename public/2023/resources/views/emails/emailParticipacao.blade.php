...
<p>Esperamos que estejas bem e tenhas usufruído do FISTA23 da melhor maneira. Esperemos que a participação tenha sido do
	teu agrado e que nos possamos encontrar em edições futuras!</p>

<br>
<p>Nesta edição, contámos com mais de 2500 estudantes presentes na tenda, mais de 400 participantes nas conferências de
	Blockchain e Web3.0 e de Metaverse e mais de 100 empresas neste evento que foi o melhor FISTA de sempre!</p>
<p>Com o intuito de crescimento e de melhoria contínua do FISTA ano após ano, pedimos-te que respondas ao questionário
	que segue abaixo, até dia 27 de Março. É essencial obtermos o teu feedback sobre o evento, de modo a melhorarmos,
	evoluirmos e proporcionarmos cada vez mais um evento mais completo!</p>
<p>https://docs.google.com/forms/d/e/1FAIpQLSdOkhvE2S1Pbsy8-LKIgBQOkhtbz23A8Mlk_4yF7_BLVG5Jcg/viewform?usp=sf_link</p>
<br>

<p>Segue também, em anexo, o teu diploma de participação.</p>
<p>Obrigada por teres estado connosco. Até breve!</p>
							...
							<table cellspacing="0" cellpadding="0"
								...
								<tbody>
									<tr>
										...
										</i></b></span><span style="color:#1EC4BD;font-size:10pt;">Miguel d'Aguiar - 910066150</span>
						</td>
					</tr>
					<tr>
